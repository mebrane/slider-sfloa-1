...
(function () {
	...
	var SamMoon = {
		...
		map: function() {
			...
			var $profile = $('.home-resources .locate .profile');

			// No need to do anything if there is no map
			...
			function enter(e) {
				e.preventDefault();
				var $this 	= $(this);
				var name 		= $this.attr('name').replace(' ', '<br/>');
				var email 	= $this.attr('email');
				var image 	= $this.attr('image');
				var profile	= {
					width: $profile.outerWidth(),
					height: $profile.outerHeight()
				};
				var pos 		= $this.position();
				var width		= $this.outerWidth();
				var html 		= '<div class="profile-container"><div class="picture" style="background-image: url(' + image + ');"></div>' +
					'<div class="info">' +
				...
				console.log(profile, pos);

				// Calculate where on the page to put it
				var left 	= pos.left + (width / 2) - (profile.width / 2);
				var top 	= pos.top - profile.height - 20;
				$profile.css({
					left: left + 'px',
					top: top + 'px'
				}).addClass('active');
